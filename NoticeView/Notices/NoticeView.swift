...
private extension NoticeView {
  ...
  func configureBackgroundViews() {
    ...
    backgroundContainerView.addAndFixInView(self)
    
    backgroundView.addAndFixInView(backgroundContainerView)
  ...
  func configureContentStackView() {
    ...
    contentStackView.addAndFixInView(backgroundView.contentView)
  ...
  func configureActionButton() {
    ...
    actionBackgroundView.backgroundColor = actionColor()
    ...
    actionButton.addAndFixInView(actionBackgroundView, space: 8)
...
private extension NoticeView {
    ...
    enum Appearance {
        static let actionColor: UIColor = .white
